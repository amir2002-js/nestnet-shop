    ...
    return (
            <div>
                ...
                <div className={`flex justify-center items-center gap-4`}>
                    ...
                    <p className={`text-lg font-peydaBold text-secondaryDark`}>پر فروش ترین محصولات</p>
                    <span className={`h-px bg-primaryLight flex-grow`}></span>
                </div>

                <Event2 idSwiper={4} filteredData={newData} totalWidth={totalWidth} url={"../../src/img/pic3.png"} dir={true} />
            </div>
    );
}
