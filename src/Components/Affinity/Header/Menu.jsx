    ...
    return (
        <div className={`p-2.5 bg-gray-200 mx-10 rounded-b-lg max-md:hidden`}>
           <ul className={`flex justify-start gap-10`}>
               {/*دسته بندی ها*/}
               <li className={`group/li text-primaryDark hover:text-primaryLight *:transition-all *:duration-300`}>
                   <button className={`flex justify-between items-center gap-2`} onClick={showGroups}>
                       {/*icon*/}
                       <div>
                       ...
                       {/*arrow icon*/}
                       <PiCaretUp className={`${ disPlay ? "" : "rotate-180" } transition-all duration-300`} />
