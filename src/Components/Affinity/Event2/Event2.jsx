...
function Event2({filteredData , totalWidth , url , dir}) {
    return (
        ...
        <div className={`max-w-maxWidth grid lg:grid-cols-4 grid-cols-1 justify-between items-center gap-4 mt-7`} dir={dir ? "ltr" : null}>
            <div className={`flex items-center justify-center`}>
                <img src={url} alt="img" className={` max-xmd:px-12 w-96 col-span-1`}/>
            </div>
            ...
            <div className={`2xl:hidden w-full flex col-span-3`} dir={dir ? "rtl" : null}>
